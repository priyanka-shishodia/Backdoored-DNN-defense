...
def main():
    ...
    model_GoodNet = keras.models.load_model('../models/repaired_nets/model_GoodNet_anon1.h5')
    model_BadNet = keras.models.load_model('../models/anonymous_1_bd_net.h5')
    ...
    for i in range(len(x_test)):
        ...
        if uniquevals <= repair.anon1thr: #if poisoned
            y_hat.append(1283)
        else:
