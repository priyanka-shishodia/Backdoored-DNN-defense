...
def main():
    ...
    model_GoodNet = keras.models.load_model('../models/repaired_nets/model_GoodNet_mtmt.h5')
    model_BadNet = keras.models.load_model('../models/multi_trigger_multi_target_bd_net.h5')
    ...
    for i in range(len(x_test)):
        ...
        if uniquevals <= repair.MTMTthr: #if poisoned
            y_hat.append(1283)
        else:
